...
public abstract class BDDFactory {
    ...
    protected int save_rec(BufferedWriter out, BitSet visited, BDD root) throws IOException {
        ...
        long newCode;
        newCode = (long) code - Integer.MIN_VALUE;
        System.out.println("old: " + root.hashCode());
        System.out.println("new: " + newCode);
        System.out.println("min: " + Integer.MIN_VALUE);
        System.out.println("rec1");
        System.exit(1);
        if (!visited.isEmpty() && visited.get(i)) {
    ...
    public void setReorderTimes(int n) {
        System.err.println("setReorderTimes not yet implemented!");
    }

    public double getReorderRuntime() {
        System.err.println("getReorderTimes not yet implemented!");
        return 0.0;
    }

	public long getRuntime() {
		System.err.println("getRuntime not yet implemented!");
		return 0;
	}

	public void setRuntimeLimit(long limit) {
		System.err.println("setRuntimeLimit not yet implemented!");
	}

	public void unsetRuntimeLimit() {
		System.err.println("unsetRuntimeLimit not yet implemented!");
	}
