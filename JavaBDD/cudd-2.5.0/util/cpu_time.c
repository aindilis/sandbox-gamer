...
#if !defined(IBM_WATC) && !defined(BSD) && !defined(UNIX60) && !defined(UNIX100) && !defined(__CYGWIN32__) && !defined(vms)
#include <time.h>
#endif
...
#if !defined(IBM_PC) && !defined(BSD) && !defined(UNIX60) && !defined(UNIX100) && !defined(__CYGWIN32__) && !defined(vms)
